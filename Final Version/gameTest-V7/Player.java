...
public class Player extends Actor
{
    ...
    public static void addToDefense(double num){ defense += num;}
    
    public static double getGoldBonus(){ return goldBonus;}
    public static void addToGoldBonus(double num) {goldBonus += num;}
    ...
    private static void die() {
        startTimer = true;
        if (timer == 30)Greenfoot.setWorld(new GameOverWorld());
    }
    public static void victory() {
        startTimer = true;
        if (timer == 60) Greenfoot.setWorld(new UpgradeMenu());
    }
}