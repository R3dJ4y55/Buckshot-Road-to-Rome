...
public class MenuExplosion extends Actor
{
    ...
    private Actor buttonToClick;

    public MenuExplosion(Actor button)
    {
    ...
    public void act()
    {
        ...
        if (frame < frames.length) {
            ...
            if (buttonToClick != null && buttonToClick instanceof ImageButton) {
                ((ImageButton)buttonToClick).performClick();
            }
        }
    }
}
